...
class HuggingfaceDataset(object):
    ...
    def __init__(self, config, tokenizer, text_processor):
        ...
        ds_culturax_ru = load_dataset("uonlp/CulturaX", "en", split='train', cache_dir='../gemma_modeling/datasets',  use_auth_token=True, streaming=True).take(200_000_000).remove_columns(["timestamp", "url", "source"])
