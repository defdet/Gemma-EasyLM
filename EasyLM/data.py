...
class HuggingfaceDataset(object):
    ...
    def __init__(self, config, tokenizer, text_processor):
        ...
        ds_culturax = load_dataset("uonlp/CulturaX", "en", cache_dir='../mnt_ds/cached_ds',  use_auth_token=True, streaming=True).select(range(4_000_000)).remove_columns(["timestamp", "url", "source"])
